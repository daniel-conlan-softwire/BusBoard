...
import { getNextBusesFromPostcode, busArrival } from './backend';
...
function App(): React.ReactElement {
  ...
  const [tableData, setTableData] = useState<{[key: string]: busArrival[]}>({});
  ...
  return <>
    ...
    {
      Object.entries(tableData).map(([stopcode, busArrivals]) => {
        return <ArrivalList key={stopcode} stopcode={stopcode} arrivals={busArrivals} />
      })
    }
  </>;
}
